...
function boomnews_logo() {
	...
	<?php if(!empty($option['header_logo'])) { ?>
		<a class="logo"  href="<?php echo esc_url(home_url('/'));?>">
			...
			src="<?php echo esc_url($option['header_logo']); ?>"
			srcset="<?php echo $option['header_logo']; ?>, <?php if(!empty($option['header_logox2'])) { echo $option['header_logox2']; } ?> 2x"  alt="<?php echo the_title(); ?>"  />
		</a>
	<?php } else { ?>
		<a class="logo"  href="<?php echo esc_url(home_url('/'));?>">
